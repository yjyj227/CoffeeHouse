...
<%-- <%if (mem_id!=null) { %> --%>
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="MemberUpdateProc.do">
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="${mem.mem_phone}" name="mem_phone">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="${mem.mem_address}" name="mem_address" id="address">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								...
								<select class="form-control" name="mem_prefer">
									<option value="${mem.mem_prefer}">${mem.mem_prefer}</option>
						...
						<div class="form-group">
							<div class="col-xs-12 col-lg-12 buttons">
									...
									<button type="button" class="btn btn-danger" onclick="location.href='DeleteCheckForm.do?mem_id=${mem_id}'">회원탈퇴</button>
							</div>
						</div>
