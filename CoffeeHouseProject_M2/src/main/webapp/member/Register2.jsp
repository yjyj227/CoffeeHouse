  ...
  <body onload="regForm.mem_id.focus()">
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="RegisterProc.do">
						<div class="form-group">
							...
							<div class="col-xs-2 col-lg-2">
								<button type="button" class="btn btn-default" onclick="idCheck(this.form.mem_id.value)">중복확인</button>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="password" class="col-xs-3 col-lg-3 control-label">비밀번호 확인</label>
							<div class="col-xs-6 col-lg-6">
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" placeholder="전화번호" name="mem_phone">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" placeholder="우편번호" name="mem_zipcode">
							</div>
							<div class="col-xs-2 col-lg-2">
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" placeholder="주소" name="mem_address">
							</div>
						</div>
						
						<div class="form-group preferform">
							<label for="name" class="col-xs-3 col-lg-3 control-label">선호커피</label>
							<div class="col-xs-6 col-lg-6">
								<select class="form-control" name="mem_prefer">
									<option value="0">선택</option>
									<option value="캡슐커피">캡슐커피</option>
						...
						<div class="form-group">
							<div class="col-xs-12 col-lg-12 buttons">
									<button type="button" class="btn btn-default" onclick="inputCheck()">회원가입</button>
