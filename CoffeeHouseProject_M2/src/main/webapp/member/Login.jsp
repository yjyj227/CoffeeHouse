		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4">
					...
					<form role="form" class="form-horizontal" name="login" method="post" action="LoginProc.do">
					<div class="col-md-12">
						...
						<div class="form-group">
							<div class="col-xs-offset-2 col-xs-10 col-lg-offset-2 col-lg-10">
								...
								<button type="button" class="btn btn-default" onclick="location.href='Agreement.do'">회원가입</button>
							</div>
						</div>
						</div>
					</form>
