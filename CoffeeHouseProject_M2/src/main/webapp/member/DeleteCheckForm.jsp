	...
	<script>
		...
		<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4">
					...
					<form role="form" class="form-horizontal" name="del" method="post" action="DeleteProc.do?mem_id=${mem_id}">
						...
						<div class="form-group">
							<div class="col-xs-12 col-lg-12">
								...
								<button type="button" class="btn btn-default" onclick="location.href='MemberUpdate.do?mem_id=${mem_id}'">취소</button>
							</div>
						</div>
					</form>
