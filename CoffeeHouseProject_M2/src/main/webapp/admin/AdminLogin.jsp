		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4">
					...
					<form role="form" class="form-horizontal" name="login" method="post" action="AdminLoginProc.do">
					<div class="col-md-12">
						<div class="form-group">
							<label for="id" class="col-xs-3 col-lg-3 control-label">아이디</label>
							<div class="col-xs-9 col-lg-9">
								<input type="text" class="form-control" placeholder="아이디" name="admin_id">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-lg-9">
								<input type="password" class="form-control" placeholder="비밀번호" name="admin_passwd">
							</div>
						</div>
