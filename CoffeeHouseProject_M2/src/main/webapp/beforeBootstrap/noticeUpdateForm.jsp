...
<div>
<center>
<div class="noti"><b>글 수정</b></div>
<form method="post" name="noticeupdateform" action="noticeUpdateProc.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()">
...
<table border="1" width="900" cellspacing="0" cellpadding="5" class="noticetable">
	...
	<td width="800" align="center">
		<input type="text" name="subject" size="100" class="inputSub" value="<%=article.getSubject()%>">
	</td>
	</tr>
	<tr align="center">
	<td width="800" align="center">
		<textarea name="content" rows="20" cols="100"><%=article.getContent()%></textarea>
	</td>
	</tr>
	<tr align="center">
...
<td>
	...
	<input type="button" value="목록으로 " onclick="location.href='noticeList.jsp?pageNum=<%=pageNum%>'">
</td>
</tr>
</table>	
</form>
