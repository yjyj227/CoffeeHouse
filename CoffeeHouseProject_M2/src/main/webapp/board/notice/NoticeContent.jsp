  ...
  <body>
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="col-md-12"></div>
			<div class="col-md-12"></div>
			<div id="comment" class="col-md-12" align="left">댓글 ()</div>
			...
			<c:if test="${!empty mem_id}">
				<tr>
					<form id="writeCommentForm" role="form" class="form-horizontal"
						...
						action="NoticeCommentWriteProc.do">
						<input type="hidden" name="cnum" value="${cnum}">
						<input type="hidden" name="mem_id" value="${mem_id}">
						<input type="hidden" name="num" value="${article.num}">
						<input type="hidden" name="cref" value="${cref}">
						<input type="hidden" name="cre_step" value="${cre_step}">
						<input type="hidden" name="cre_level" value="${cre_level}">
						<td>
							<div class="col-md-1">${mem_id}</div>
							<div class="col-md-10">
								<textarea name="ccontent" rows="5" placeholder="내용을 입력하세요."
			...
			<c:forEach var="comment" items="${commentList}">
				<tr>
					...
					<c:if test="${comment.cre_level > 0}">
					<img src="./img/level.gif" width="${10*comment.cre_level}" height="1">
					</c:if>
					<c:if test="${comment.cre_level==0}">
					<img src="./img/level.gif" width="${10*comment.cre_level}" height="1">
					</c:if>
						<div class="col-md-2" align="left">${comment.cid}</div>
						<div class="col-md-2" align="left"><font size="1.5rem">${comment.creg_date}</font></div>
						<div class="col-md-8"></div>
						<div class="col-md-12" align="left">${comment.ccontent}</div>
