	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		<div class="row">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="noticeupdateform" method="post" action="NoticeUpdateProc.do?pageNum=${pageNum}" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						<td>
						<textarea name="content" rows="20" class="form-control">${article.content}</textarea>
						</td>
					</tr>	
					<tr>
						<td>
						...
						<div class="col-md-11">
						<input type="file" name="filename" size="50%"value="${article.filename} ${article.filesize}">
						</div>
						</td>
					</tr>
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='NoticeList.do?pageNum=${pageNum}'">목록으로</button>
						</div>
						<div class="col-md-8">
