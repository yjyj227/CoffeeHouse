...
<%
	...
	System.out.println("NotiveDeleteForm.jsp의 num=>"+num+", pageNum=>"+pageNum);
	...
	System.out.println("NoticeDeleteForm.jsp의 mem_id=>"+mem_id); //null이라면? ...
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <body>
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<script>
			...
			if (result) {
				location.href="NoticeDeleteProc.jsp?num=<%=num%>&pageNum=<%=pageNum%>"
			}else{
				history.back();
			}
		</script>
