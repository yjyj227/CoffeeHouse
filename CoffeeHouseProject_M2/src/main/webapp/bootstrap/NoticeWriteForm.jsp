	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="noticewriteform" method="post" action="NoticeWriteProc.jsp" onsubmit="return writeSave()">
				...
				<thead>
					...
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='NoticeList.jsp'">목록으로</button>
						</div>
						<div class="col-md-8">
