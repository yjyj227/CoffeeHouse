...
<%
	...
	String mem_id=request.getParameter("mem_id"); //Object이기 때문에 String으로 형변환 해줘야함
	System.out.println("DeleteCheckForm.jsp의 mem_id=>"+mem_id); //null이라면? ...
%>
<!DOCTYPE html>
<html>
<head>
	...
	<script>
		...
		<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4">
					...
					<form role="form" class="form-horizontal" name="del" method="post" action="DeleteProc.jsp?mem_id=<%=mem_id%>">
						...
						<div class="form-group">
							<div class="col-xs-12 col-lg-12">
								...
								<button type="button" class="btn btn-default" onclick="location.href='MemberUpdate.jsp?mem_id=<%=mem_id%>'">취소</button>
							</div>
						</div>
					</form>
