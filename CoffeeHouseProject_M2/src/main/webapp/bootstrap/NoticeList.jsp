...
//	pgList.get("count"); => ${pgList.count}
	...
	System.out.println("NoticeList.do의 mem_id=>"+mem_id); //null이라면? ...
%>
<!DOCTYPE html>
<%!
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
				...
				<table class="table">
					...
					<c:forEach var="article" items="${articleList}">
						<tr>
							...
							<a href="NoticeContent.jsp?num=${article.num}&pageNum=${pgList.currentPage}">${article.subject}</a>
			...
			<%if (mem_id!=null) {
				...
				<button type="button" class="btn btn-default" onclick="document.location='NoticeWriteForm.jsp'">글쓰기</button>
				<%}
			}%>
			</div><!-- 글쓰기버튼 -->
			</div>
