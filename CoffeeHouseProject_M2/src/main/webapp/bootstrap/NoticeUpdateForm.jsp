...
<%
	...
	System.out.println("NoticeUpdateForm.jsp의 mem_id=>"+mem_id); //null이라면? ...
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		<div class="row">
			...
			<div class="form-group">
				<form role="form" class="form-horizontal" name="noticeupdateform" method="post" action="NoticeUpdateProc.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()">
				...
				<thead>
					<tr>
						<td>
						<input type="text" name="subject" class="form-control" value="<%=article.getSubject()%>">
						</td>
					</tr>
				</thead>
					<tr>
						<td>
						<textarea name="content" rows="20" class="form-control"><%=article.getContent()%></textarea>
						</td>
					</tr>	
					<tr>
						<td>
						...
						<div class="col-md-11">
						<input type="file" name="filename" size="50%"value="<%=article.getFilename()%> <%=article.getFilesize()%>">
						</div>
						</td>
					</tr>
					<tr>
						...
						<button type="button" class="btn btn-default" onclick="location.href='NoticeList.jsp?pageNum=<%=pageNum%>'">목록으로</button>
						</div>
						<div class="col-md-8">
