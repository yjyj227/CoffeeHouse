  ...
  <body>
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="col-md-12 pagetitle">작성하신 내용을 다시 한 번 확인해주세요.</div>
			<div class="col-md-12">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="MemberInsert.jsp">
						<div class="form-group">
							<div class="col-xs-12 col-lg-12"></div>
							<label for="id" class="col-xs-3 col-lg-3 control-label">아이디</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_id" />" name="mem_id">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="password" class="form-control" value="<jsp:getProperty name="mem" property="mem_passwd" />" name="mem_passwd">
							</div>
						</div>
						
						<div class="form-group">
							<label for="name" class="col-xs-3 col-lg-3 control-label">이름</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_name" />" name="mem_name">
							</div>
						</div>
						
						<div class="form-group">
							<label for="email" class="col-xs-3 col-lg-3 control-label">이메일</label>
							<div class="col-xs-6 col-lg-6">
								<input type="email" class="form-control" value="<jsp:getProperty name="mem" property="mem_email" />" name="mem_email">
							</div>
						</div>
						
						<div class="form-group">
							<label for="name" class="col-xs-3 col-lg-3 control-label">전화번호</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_phone" />" name="mem_phone">
							</div>
						</div>
						
						<div class="form-group">
							<label for="name" class="col-xs-3 col-lg-3 control-label">우편번호</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_zipcode" />" name="mem_zipcode">
							</div>
						...
						<div class="form-group">
							<label for="address" class="col-xs-3 col-lg-3 control-label">주소</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_address" />" name="mem_address">
							</div>
						</div>
						
						<div class="form-group">
							<label for="name" class="col-xs-3 col-lg-3 control-label">선호커피</label>
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<jsp:getProperty name="mem" property="mem_prefer" />" name="mem_address">
							</div>
						</div>

						<div class="form-group">
							<div class="col-xs-12 col-lg-12 buttons">
									<button type="submit" class="btn btn-default">확인완료</button>
									<button type="button" class="btn btn-default" onclick="history.back()">다시쓰기</button>
							</div>
						</div>
					</form>
