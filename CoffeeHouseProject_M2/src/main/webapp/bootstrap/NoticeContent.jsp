				...
				<ul class="nav nav-pills navbar-right nv1">
					...
					<!-- 이벤트 대상 -->
						<ul class="dropdown-menu">
							<li><a href="MemberUpdate.jsp">회원정보</a></li>
							<li><a href="#">주문조회</a></li>
							<li><a href="#">장바구니</a></li>
							<li><a href="#">관심상품</a></li>
							<li><a href="#">적립금</a></li>
			...
			<table class="table">
					...
					<tr>
						<td>
							...
							<div class="col-md-2">${article.reg_date}</div>
					...
					<tr>
						<td>
						<div class="col-md-12 contentarea" align="left">${article.content}</div>
						</td>
					</tr>
					<tr>
						<td>
						...
						<button type="button" class="btn btn-warning" onclick="document.location='NoticeUpdateForm.jsp?num=${article.num}&pageNum=${pageNum}'">수정</button>
						
						
						<button type="button" class="btn btn-danger" onclick="document.location='NoticeDeleteForm.jsp?num=${article.num}&pageNum=${pageNum}'">삭제</button>
						
						</c:if>
						<%} %>
						<button type="button" class="btn btn-default" onclick="document.location='NoticeWriteFrom.jsp?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">답글쓰기</button>
