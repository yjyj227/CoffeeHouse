...
<%
	...
	System.out.println("MemberUpdate.jsp의 mem_id=>"+mem_id); //null이라면? ...
...
<%if (mem_id!=null) { %>
		...
		<div class="row1"><!-- 로그인 마이페이지 -->
			<div class="col-md-offset-8 col-md-4">
				<ul class="nav nav-pills navbar-right nv1">
					<%if (mem_id!=null) {%>
					<li class="disabled"><a><%=mem_id%>님 환영합니다.</a></li>
	...
	<a class="topbutton" href="#"><img src="img/topbutton.png"></a>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<form role="form" class="form-horizontal" name="regForm" method="post" action="MemberUpdateProc.jsp">
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="password" class="form-control" value="<%=mem.getMem_passwd()%>" name="mem_passwd">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<%=mem.getMem_name()%>" name="mem_name">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="email" class="form-control" value="<%=mem.getMem_email()%>" name="mem_email">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<%=mem.getMem_phone()%>" name="mem_phone">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<%=mem.getMem_zipcode()%>" name="mem_zipcode">
							</div>
							<div class="col-xs-2 col-lg-2">
								<button type="button" class="btn btn-default" onclick="zipCheck()">우편번호 찾기</button>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<%=mem.getMem_address()%>" name="mem_address">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6 col-lg-6">
								<input type="text" class="form-control" value="<%=mem.getMem_prefer()%>" name="mem_address">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-12 col-lg-12 buttons">
									...
									<button type="button" class="btn btn-danger" onclick="location.href='DeleteCheckForm.jsp?mem_id=<%=mem_id%>'">회원탈퇴</button>
							</div>
						</div>
